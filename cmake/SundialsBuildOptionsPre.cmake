...
if(USE_XSDK_DEFAULTS)
  ...
  set(SUNDIALS_INDEX_SIZE "32" CACHE STRING "32 or 64" FORCE)
  message(STATUS "  Setting index size to 32")
endif()
...
sundials_option(ENABLE_FORTRAN BOOL "Enable Fortran interfaces" OFF)

# Fortran interface is disabled by default
set(DOCSTR "Enable Fortran 77 interfaces")
sundials_option(BUILD_FORTRAN77_INTERFACE BOOL "${DOCSTR}" ${ENABLE_FORTRAN}
                DEPENDS_ON ENABLE_FORTRAN)
...
if(BUILD_FORTRAN77_INTERFACE)
  ...
  elseif(NOT BUILD_STATIC_LIBS)
    print_warning("Fortran 77 interfaces can only be built as static libraries" "Disabling F77 interface")
    set(BUILD_FORTRAN77_INTERFACE OFF CACHE BOOL "${DOCSTR}" FORCE)
  endif()
endif()
...
sundials_option(BUILD_FORTRAN_MODULE_INTERFACE BOOL "${DOCSTR}" ${ENABLE_FORTRAN}
                DEPENDS_ON ENABLE_FORTRAN)
