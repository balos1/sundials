...
# TODO: Should this be for Apple or clang in general?
if(APPLE)
...
if (BUILD_FORTRAN_MODULE_INTERFACE AND (NOT F2003_FOUND))
  print_warning("Compiler with Fortran 2003 support not found" "Setting BUILD_FORTRAN_MODULE_INTERFACE to OFF")
  set(DOCSTR "Enable SUNDIALS Fortran 2003 module interfaces")
  force_variable(BUILD_FORTRAN_MODULE_INTERFACE BOOL "${DOCSTR}" OFF)
endif()
...
if(ENABLE_FORTRAN AND Fortran_FOUND)
