...
# generate the macros which identify what TPLs SUNDIALS has been built with
set(SUNDIALS_CONFIGH_TPLS "")
foreach(_tpl ${SUNDIALS_TPL_LIST})
  string(APPEND SUNDIALS_CONFIGH_TPLS "#define SUNDIALS_${_tpl} 1\n")
endforeach()
...
foreach(_item ${SUNDIALS_BUILD_LIST})
  if(${${_item}})
    string(APPEND SUNDIALS_CONFIGH_BUILDS "#define SUNDIALS_${_item} 1\n")
  endif()
endforeach()
