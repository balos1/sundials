...
#                        [OBJECT_LIB_ONLY])
#
# adds libraries to be built from the source files listed in the command invocation. It
# is a convenient wrapper of the CMake add_library command that is specific to our usage
# of add_library in SUNDIALS.
#
# By default, the macro uses the CMake add_library command to create the targets:
#   - <target> (will be a shared library)
#   - <target>${STATIC_LIB_SUFFFIX} (will be a static library)
#   - <target>_obj (an object library that is used to create <target>)
#   - <target>_obj${_STATIC_LIB_SUFFIX} (an object library that is used to create <target>${_STATIC_LIB_SUFFIX})
# The option OBJECT_LIB_ONLY will cause the macro to only create the object library targets.
# The option STATIC_ONLY will cause the macro to only create the static library targets.
# The option SHARED_ONLY will cause the macro to only create the shared library targets.
#
...
#
# The option OBJECT_LIBRARIES is a list of object library to include when building the target.
# This is similar to adding more source files, but its done using the already compiled objects.
#
# The option LINK_LIBRARIES is a list that is passed to target_link_libraries on all the targets
# generated by the macro. See the CMake target_link_libraries documentation for more info.
#
# The option INCLUDE_DIRECTORIES is a list that is passed to target_include_directories on all
# the targets generated by the macro. See the CMake target_include_directories documentation
# for more info.
#
# The option COMPILE_DEFINITIONS is a list that is passed to target_compile_definitions on all
# the targets generated by the macro. See the CMake target_compile_definitions documentation
# for more info.
#
# The option COMPILE_OPTIONS is a list that is passed to target_compile_options on all
# the targets generated by the macro. See the CMake target_compile_options documentation
# for more info.
#
# The option COMPILE_FEATURES is a list that is passed to target_compile_features on all
# the targets generated by the macro. See the CMake target_compile_features documentation
# for more info.
#
# The option PROPERTIES is a list that is passed to set_target_properties on all the
# targets generated by the macro. See the CMake set_target_properties documentation
# for more info.
macro(sundials_add_library target)

  set(options OBJECT_LIB_ONLY STATIC_ONLY SHARED_ONLY)
  ...
  set(multiValueArgs SOURCES OBJECT_LIBRARIES LINK_LIBRARIES INCLUDE_DIRECTORIES
                     COMPILE_DEFINITIONS COMPILE_OPTIONS COMPILE_FEATURES PROPERTIES)
  ...
  foreach(_libtype ${_libtypes})
    ...
    # add compile definitions to object library
    if(${_libtype} MATCHES "STATIC")
