...
if(NOT MPI_C_COMPILER)
  ...
  # Process test result
  if(MPI_TEST_OK)
    message(STATUS "Check if the provided C compiler is a working MPI C compiler: ${CMAKE_C_COMPILER} -- yes")
    set(MPI_C_COMPILER ${CMAKE_C_COMPILER})
    set(MPI_C_FOUND TRUE)
  else()
    message(STATUS "Check if the provided C compiler is a working MPI C compiler: ${CMAKE_C_COMPILER} -- no")
  endif()
...
if(MPI_C_FOUND)
  ...
  if(CXX_FOUND AND (NOT MPI_CXX_COMPILER))
    ...
    # Process test result
    if(MPI_TEST_OK)
      message(STATUS "Check if CMAKE_CXX_COMPILER is a working MPI C++ compiler: ${CMAKE_CXX_COMPILER} -- yes")
      set(MPI_CXX_COMPILER ${CMAKE_CXX_COMPILER})
      set(MPI_CXX_FOUND TRUE)
    else()
      message(STATUS "Check if CMAKE_CXX_COMPILER is a working MPI C++ compiler: ${CMAKE_CXX_COMPILER} -- no")
    endif()
  ...
  if((F77_FOUND OR F90_FOUND) AND (NOT MPI_Fortran_COMPILER))
    ...
    # Process test result
    if(MPI_TEST_OK)
      message(STATUS "Check if the provided Fortran compiler is a working MPI Fortran compiler: ${CMAKE_Fortran_COMPILER} -- works")
      set(MPI_Fortran_COMPILER ${CMAKE_Fortran_COMPILER})
      set(MPI_Fortran_FOUND TRUE)
    else()
      message(STATUS "Check if the provided Fortran compiler is a working MPI Fortran compiler: ${CMAKE_Fortran_COMPILER} -- broken")
    endif()
...
# TODO: We can probably remove this now since MPI-2 is widely supported.
# However, we may want to check for MPI-3 support since the MPIManyVector
# requires it.
# ---------------------------------------------------------------------------
if(MPI_C_FOUND)
