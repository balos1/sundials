...
# Using Trilinos requires building with MPI enabled
if(ENABLE_TRILINOS AND NOT ENABLE_MPI)
  print_error("MPI is required for Trilinos support. Set ENABLE_MPI to ON.")
endif()
...
# We need MPI for Trilinos support
include(SundialsMPI)
