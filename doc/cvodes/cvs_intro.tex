...
The expected behavior of the \id{SUNNonlinSolGetNumIters} function in the
...
retreived by calling \id{CVGetNumNonlinSolvIters}, \id{CVGetNonlinSolvStats},
\id{CVGetSensNumNonlinSolvIters}, or \id{CVGetSensNonlinSolvStats}.
...
A new set function, \id{CVodeSetMaxStepsBetweenLSetup}. has been added to set
