...
Added the function \id{IDASetNlsResFn} to supply an alternative residual side
...
Fixed a bug with \id{IDASetJacTimesResFn} where the supplied function was used
in the dense finite difference Jacobian computation rather than the finite
